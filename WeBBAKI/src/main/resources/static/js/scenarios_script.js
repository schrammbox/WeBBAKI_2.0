...
var masterScenarioString = "<div class=\"masterScenario\" id=\"masterScenario{masterScenarioIndex}\">\n" +
    ...
    "            </div>\n" +
    "            <div>\n" +
    "              <button type=\"button\" value=\"{masterScenarioIndex}\" onclick=\"deleteMasterScenario(this)\">Löschen</button>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"scenarios\">\n" +
    ...
    "            </div>\n" +
    "            \n" +
    "            <button onclick=\"createScenario(this)\" type=\"button\" class=\"addScenarioButton\" value=\"{masterScenarioIndex};0\">Scenario hinzufügen</button>\n" +
    "          </div>\n" +
    "        </div>"
