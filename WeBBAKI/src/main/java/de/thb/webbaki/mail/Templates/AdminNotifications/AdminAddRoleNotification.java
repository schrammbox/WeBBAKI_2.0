...
public class AdminAddRoleNotification {

    public static String changeRole(String userFirstname, String userLastname, Role role, String username) {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "    <p>Einer der Superadmins hat folgendem Nutzer eine neue Rolle gegeben:</p>\n" +
